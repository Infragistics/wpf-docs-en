...
This section lists each namespace that is relevant to the link:{ApiPlatform}dragdrop{ApiVersion}.html[Infragistics Drag and Drop Framework]™ library. There are also several key classes listed that you will be using while programming with this control. The namespaces and classes on this page link directly into our API documentation.
