...
The two variables titled *z* will be equivalent. The second notation is less computationally efficient because it involves the construction of link:{ApiPlatform}math{ApiVersion}~infragistics.math.constant.html[Constant.I], plus an addition and multiplication operation.
