...
The Infragistics Excel Engine allows you to customize the look and behavior of a cell. You can customize a cell by setting properties exposed by the link:{ApiPlatform}documents.excel.v{ProductVersion}~infragistics.documents.excel.worksheetcell~cellformat.html[CellFormat] property of the link:{ApiPlatform}documents.excel.v{ProductVersion}~infragistics.documents.excel.worksheetcell.html[WorksheetCell], link:{ApiPlatform}documents.excel.v{ProductVersion}~infragistics.documents.excel.worksheetrow.html[WorksheetRow], link:{ApiPlatform}documents.excel.v{ProductVersion}~infragistics.documents.excel.worksheetcolumn.html[WorksheetColumn], or link:{ApiPlatform}documents.excel.v{ProductVersion}~infragistics.documents.excel.worksheetmergedcellsregion.html[WorksheetMergedCellsRegion] objects.
