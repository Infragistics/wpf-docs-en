...
Use the link:{RootAssembly}{ApiVersion}~infragistics.themes.thememanager.html[ThemeManager] link:{RootAssembly}{ApiVersion}~infragistics.themes.thememanager~applicationtheme.html[ApplicationTheme] property to set a theme to an application.
