...
The following procedure walks you through the creating and applying a custom theme to the link:{ApiPlatform}controls.layouts.xamtilemanager.v{ProductVersion}~infragistics.controls.layouts.xamtilemanager_members.html[XamTileManager] control using ThemeManager.
