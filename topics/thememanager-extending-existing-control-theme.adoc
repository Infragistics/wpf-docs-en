...
+
Create a class named ExtendedOffice2013Theme that derives from the link:{ApiPlatform}themes.office2013.v{ProductVersion}~infragistics.themes.office2013theme_members.html[Office2013Theme] class:
+
*In C#:*
+
[source,csharp]
