...
Controls derived from link:infragisticswpf4.datapresenter.v{ProductVersion}~infragistics.windows.datapresenter.datapresenterbase.html[DataPresenterBase] (i.e., xamDataGrid™, xamDataPresenter™, and xamDataCarousel™) have a link:infragisticswpf4.datapresenter.v{ProductVersion}~infragistics.windows.datapresenter.datapresenterbase~theme.html[Theme] property that can be set to one of several predefined themes to get started quickly.
