...
To add inline pictures to a paragraph, you use the the link:{ApiPlatform}documents.io{ApiVersion}~infragistics.documents.word.worddocumentwriter~addinlinepicture.html[AddInlinePicture] method of the WordDocumentWriter object.
