...
[NOTE]
====
A reference to the link:{ApiPlatform}documents.io{ApiVersion}.html[{ApiPlatform}Documents.IO.v{ProductVersion}.dll] assembly is required for the following code.
====
