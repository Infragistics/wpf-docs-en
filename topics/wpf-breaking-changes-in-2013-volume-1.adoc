...
The RecordFilterAction link:{ApiPlatform}datapresenter.v{ProductVersion}~infragistics.windows.datapresenter.recordfilteraction.html[RecordFilterAction] enumeration’s constant  *None*  is obsoleted. It is replaced with a new equivalent constant –  *ReduceOpacity* .
