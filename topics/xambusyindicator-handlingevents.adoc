...
|This event is invoked when the link:{RootAssembly}{ApiVersion}~infragistics.controls.interactions.xambusyindicator_members.html[XamBusyIndicator] link:{RootAssembly}{ApiVersion}~infragistics.controls.interactions.xambusyindicator~isbusy.html[IsBusy] property has changed.
...
|This event is invoked when the `XamBusyIndicator` link:{RootAssembly}{ApiVersion}~infragistics.controls.interactions.xambusyindicator~isindicatorvisible.html[IsIndicatorVisible] property has changed.
...
|This event is invoked when the `XamBusyIndicator` link:{RootAssembly}{ApiVersion}~infragistics.controls.interactions.xambusyindicator~progressvalue.html[ProgressValue] has reached its maximum value of 1.
