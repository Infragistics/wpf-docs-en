...
XamDataGrid will automatically use xamCheckEditor as the default editor for boolean type fields. However for fields of other types, follow these steps to display a xamCheckEditor in a link:{ApiPlatform}datapresenter{ApiVersion}~infragistics.windows.datapresenter.field.html[Field] of xamDataGrid.
