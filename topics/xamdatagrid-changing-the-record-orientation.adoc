...
The xamDataPresenter's™ Grid View shows link:{ApiPlatform}datapresenter.v{ProductVersion}~infragistics.windows.datapresenter.record.html[Record]s in either vertical (default) or horizontal orientation. To show records in horizontal orientation, set the link:{ApiPlatform}datapresenter.v{ProductVersion}~infragistics.windows.datapresenter.gridviewsettings~orientation.html[Orientation] property off the link:{ApiPlatform}datapresenter.v{ProductVersion}~infragistics.windows.datapresenter.gridviewsettings.html[GridViewSettings].
