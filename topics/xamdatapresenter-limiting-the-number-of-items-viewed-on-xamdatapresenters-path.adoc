...
The xamDataPresenter's™ Carousel View displays a number of Records along a path. You can change the amount of Records displayed by setting the link:{RootAssembly}{ApiVersion}~infragistics.windows.controls.carouselviewsettings~itemsperpage.html[ItemsPerPage] property off the CarouselViewSettings object.
