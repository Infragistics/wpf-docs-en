...
You can set the RepeatType property to the following link:{RootAssembly}{ApiVersion}~infragistics.windows.reporting.repeattype.html[RepeatType enumeration] values:
