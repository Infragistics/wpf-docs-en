...
link:{ApiPlatform}controls.editors.xammaskedinput.v{ProductVersion}~infragistics.controls.editors.xammaskedinput~autofilldate.html[AutoFillDate] 

link:{ApiPlatform}controls.editors.xamdatetimeinput.v{ProductVersion}~infragistics.controls.editors.xamdatetimeinput~dropdownbuttondisplaymode.html[DropDownButtonDisplayMode] 
