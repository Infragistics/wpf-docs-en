...
The following table maps the visual elements of the link:{ApiPlatform}controls.charts.xamdiagram.v{ProductVersion}~infragistics.controls.charts.xamdiagram_members.html[XamDiagram] control and the properties that configure them.
...
|1
|Node
| link:{ApiPlatform}controls.charts.xamdiagram.v{ProductVersion}~infragistics.controls.charts.xamdiagram~items.html[Items]
...
The following table maps the visual elements of link:{ApiPlatform}controls.charts.xamdiagram.v{ProductVersion}~infragistics.controls.charts.diagramnode_members.html[DiagramNode]s and the properties that configure them.
...
|2
|Resize handle
| link:{ApiPlatform}controls.charts.xamdiagram.v{ProductVersion}~infragistics.controls.charts.primitives.diagramresizehandle.html[DiagramResizeHandle] 

link:{ApiPlatform}controls.charts.xamdiagram.v{ProductVersion}~infragistics.controls.charts.primitives.diagramresizehandleline.html[DiagramResizeHandleLine]
...
The following table maps the visual elements of the link:{ApiPlatform}controls.charts.xamdiagram.v{ProductVersion}~infragistics.controls.charts.diagramconnection_members.html[DiagramConnection]s and the properties that configure them.
...
|4
|Connection handle
| link:{ApiPlatform}controls.charts.xamdiagram.v{ProductVersion}~infragistics.controls.charts.primitives.diagramconnectionhandle.html[DiagramConnectionHandle]
...
The following table maps the visual elements of the link:{ApiPlatform}controls.charts.xamdiagram.v{ProductVersion}~infragistics.controls.charts.xamdiagramtoolbox_members.html[XamDiagramToolbox] control and the properties that configure them.
...
|2
|Toolbox item
| link:{ApiPlatform}controls.charts.xamdiagram.v{ProductVersion}~infragistics.controls.charts.diagramtoolboxcategory~items.html[DiagramToolboxCategory.Items]

|3
|Toolbox item diagram item
| link:{ApiPlatform}controls.charts.xamdiagram.v{ProductVersion}~infragistics.controls.charts.diagramtoolboxitem~item.html[DiagramToolboxItem.Item]

|4
|Toolbox item title
| link:{ApiPlatform}controls.charts.xamdiagram.v{ProductVersion}~infragistics.controls.charts.diagramtoolboxitem~title.html[DiagramToolboxItem.Title]
...
|6
|Category name
| link:{ApiPlatform}controls.charts.xamdiagram.v{ProductVersion}~infragistics.controls.charts.diagramtoolboxcategory~name.html[DiagramToolboxCategory.Name]
