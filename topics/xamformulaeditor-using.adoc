...
|
* link:{ApiPlatform}controls.interactions.xamformulaeditor.v{ProductVersion}~infragistics.controls.interactions.formulaeditorbase~target.html[Target] 

* link:{ApiPlatform}controls.interactions.xamformulaeditor.v{ProductVersion}~infragistics.controls.interactions.formulaeditorbase~formula.html[Formula] 
