...
The topics in this group explain the  _xamGantt™_   link:{ApiPlatform}controls.schedules.xamgantt{ApiVersion}~infragistics.controls.schedules.project_members.html[Project] class, its configurable aspects and the main features it provides.
