...
| link:{ApiPlatform}controls.schedules.xamgantt.v{ProductVersion}~infragistics.controls.schedules.xamgantt~gridwidth.html[GridWidth]

|Chart Section Width
|Set the width of the chart section with a value of type `GridLength`.
| link:{ApiPlatform}controls.schedules.xamgantt.v{ProductVersion}~infragistics.controls.schedules.xamgantt~chartwidth.html[ChartWidth]
