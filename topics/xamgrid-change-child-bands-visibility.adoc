...
Using the xamGrid™ control's link:{ApiPlatform}controls.grids.xamgrid.v{ProductVersion}~infragistics.controls.grids.columnlayoutheadervisibility.html[ColumnLayoutHeaderVisibility] property, you can change the visibility of ChildBand header rows which hold child rows for a particular ColumnLayout. The following table shows the members of the ColumnLayoutHeaderVisibility property.

[options="header", cols="a,a"]
|====
|ColumnLayoutHeaderVisibility|Description

| link:{ApiPlatform}controls.grids.xamgrid.v{ProductVersion}~infragistics.controls.grids.columnlayoutheadervisibility.html[Always]
|The ChildBands header rows will always be visible.

| link:{ApiPlatform}controls.grids.xamgrid.v{ProductVersion}~infragistics.controls.grids.columnlayoutheadervisibility.html[Never]
|The ChildBands header rows will never be visible.

| link:{ApiPlatform}controls.grids.xamgrid.v{ProductVersion}~infragistics.controls.grids.columnlayoutheadervisibility.html[SiblingsExist]
