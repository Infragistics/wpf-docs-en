...
You can enable ToolTips by setting the Column’s link:{ApiPlatform}controls.grids.xamgrid.v{ProductVersion}~infragistics.controls.grids.column~allowtooltips.html[AllowToolTips] property to one of the following values of the AllowToolTips enumeration:

* link:{ApiPlatform}controls.grids.xamgrid.v{ProductVersion}~infragistics.controls.grids.allowtooltips.html[Always]: Display the ToolTips whenever the end user hovers over the cell.
* link:{ApiPlatform}controls.grids.xamgrid.v{ProductVersion}~infragistics.controls.grids.allowtooltips.html[Never]: Never display the ToolTips.
* link:{ApiPlatform}controls.grids.xamgrid.v{ProductVersion}~infragistics.controls.grids.allowtooltips.html[Overflow]: Only display the ToolTips when the cell content overflows.
...
You can style the ToolTip by setting the link:{ApiPlatform}controls.grids.xamgrid.v{ProductVersion}~infragistics.controls.grids.column~tooltipstyle.html[ToolTipStyle] property that targets the ToolTip control.

You can specify the content of the ToolTip by setting the link:{ApiPlatform}controls.grids.xamgrid.v{ProductVersion}~infragistics.controls.grids.column~tooltipcontenttemplate.html[ToolTipContentTemplate] property to an instance of a data template. The DataContext of this property is the Row’s data.
