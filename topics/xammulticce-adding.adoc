...
+
In order to add a xamMultiColumnComboEditor to your application you must add the {ApiPlatform}{ApiVersion}dll, {ApiPlatform}DataManager{ApiVersion}.dll and the {ApiPlatform}Controls.Editors.XamComboEditor{ApiVersion}.dll assemblies to your project.
.. *Add the Infragistics namespace*
+
*In XAML:*
+
