...
The Network Node control is a ready-to-use, data-bound control for rendering undirected graphs. An example graph, as rendered by the link:{ApiPlatform}controls.maps.xamnetworknode{ApiVersion}~infragistics.controls.maps.xamnetworknode.html[xamNetworkNode]™ control, is given in Figure 1.
