...
This topic provides detailed instructions to help you get up and running as soon as possible with the link:{ApiPlatform}controls.menus.xamradialmenu.v{ProductVersion}~infragistics.controls.menus.xamradialmenu.html[ _xamRadialMenu_  ]™.
...
*InfragisticsWPF4.DataVisualization.v{ProductVersion}*

*InfragisticsWPF4.Controls.Menus.XamRadialMenu.v{ProductVersion}*
