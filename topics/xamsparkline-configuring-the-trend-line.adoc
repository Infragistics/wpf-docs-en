...
This topic explains, with code examples, how to configure the trend line of link:{ApiPlatform}controls.charts.xamsparkline{ApiVersion}.html[xamSparkline]™ for custom appearance and color.
