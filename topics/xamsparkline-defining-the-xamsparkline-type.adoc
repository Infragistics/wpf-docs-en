...
This topic explains, with code examples, how to define the link:{ApiPlatform}controls.charts.xamsparkline{ApiVersion}.html[xamSparkline]™ type. There are individual sections about specifying the Win/Loss type because of the special requirements of this Sparkline type.
