...
[start=3]
. Set the link:{ApiPlatform}controls.interactions.xamspellchecker.v{ProductVersion}~infragistics.controls.interactions.xamspellchecker~dictionaryuri.html[DictionaryUri] property to the Uri of the French dictionary.
