...
|In this topic, you will find instructions and code examples for using the _xamSyntaxEditor_ link:{ApiPlatform}documents.textdocument{ApiVersion}~infragistics.documents.textdocument_members.html[TextDocument]'s Load and Save methods for loading and saving content.
