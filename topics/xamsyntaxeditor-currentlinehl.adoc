...
|
* link:{ApiPlatform}controls.editors.xamsyntaxeditor.v{ProductVersion}~infragistics.controls.editors.xamsyntaxeditor~currentlinehighlightvisibility.html[CurrentLineHighlightVisibility] 

|<<_Ref343682991,Set the Current Line Highlighting Background Brush>>
|Sets the background brush of the current line highlight
|
* link:{ApiPlatform}controls.editors.xamsyntaxeditor.v{ProductVersion}~infragistics.controls.editors.xamsyntaxeditor~currentlinehighlightbackgroundbrush.html[CurrentLineHighlightBackgroundBrush] 

|<<_Ref343850371,Set the Current Line Highlighting Border Brush>>
|Sets the border brush of the current line highlight
|
* link:{ApiPlatform}controls.editors.xamsyntaxeditor.v{ProductVersion}~infragistics.controls.editors.xamsyntaxeditor~currentlinehighlightborderbrush.html[CurrentLineHighlightBorderBrush] 
