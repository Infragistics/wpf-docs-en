...
|
* link:{ApiPlatform}controls.editors.xamsyntaxeditor.v{ProductVersion}~infragistics.controls.editors.xamsyntaxeditor~splitoptions.html[SplitOptions] 

|<<_Ref332805564,Obtain/Set the Current Splitting Status>>
|You can obtain/set the current splitting status and see if and how the user has split the editing area.
|
* link:{ApiPlatform}controls.editors.xamsyntaxeditor.v{ProductVersion}~infragistics.controls.editors.xamsyntaxeditor~splitstatus.html[SplitStatus] 
...
|`SplitOptions`
|A value of type link:{ApiPlatform}controls.editors.xamsyntaxeditor.v{ProductVersion}~infragistics.controls.editors.editordocumentviewsplitoptions.html[EditorDocumentViewSplitOptions]
...
|`SplitStatus`
|Set it to a value of type link:{ApiPlatform}controls.editors.xamsyntaxeditor.v{ProductVersion}~infragistics.controls.editors.editordocumentviewsplitstatus.html[EditorDocumentViewSplitStatus]
