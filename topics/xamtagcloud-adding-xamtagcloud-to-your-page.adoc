...
** link:{ApiPlatform}controls.menus.xamtagcloud.v{ProductVersion}~infragistics.controls.menus.xamtagcloudpanel~horizontalcontentalignment.html[HorizontalContentAlignment] – Stretch
** link:{ApiPlatform}controls.menus.xamtagcloud.v{ProductVersion}~infragistics.controls.menus.xamtagcloudpanel~verticalcontentalignment.html[VerticalContentAlignment] – Stretch
** Height – 300
** Width – 250
** link:{ApiPlatform}controls.menus.xamtagcloud.v{ProductVersion}~infragistics.controls.menus.xamtagcloudpanel~maxscale.html[MaxScale] – 5
** link:{ApiPlatform}controls.menus.xamtagcloud.v{ProductVersion}~infragistics.controls.menus.xamtagcloudpanel~minscale.html[MinScale] - 1
