...
The following xaml code shows you how to change the color, size, and intervals of the major and minor tickmarks using styles in link:{ApiPlatform}controls.timelines.xamtimeline{ApiVersion}~infragistics.controls.timelines.xamtimeline.html[XamTimeline] control.
