...
The following steps demonstrate how to add the link:{ApiPlatform}datapresenter.v{ProductVersion}~infragistics.windows.datapresenter.xamtreegrid.html[xamTreeGrid] to your page.
...
Add the  _xamTreeGrid_   control to your page. Add an alias to the name space of the data source class and instantiate the data source class as a data context of the  _xamTreeGrid_  . Bind the  _xamTreeGrid's_   link:{ApiPlatform}datapresenter.v{ProductVersion}~infragistics.windows.datapresenter.datapresenterbase~datasource.html[DataSource] property to the `FileNodes` property of the data context.
